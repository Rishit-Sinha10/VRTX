...
function FormationBuilder() {
    ...
    if ($[0] !== "8281f7070cc5dda4d28d63ec601eed0afba655ac59bcdecfff80547315de82b6") {
        for(let $i = 0; $i < 31; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8281f7070cc5dda4d28d63ec601eed0afba655ac59bcdecfff80547315de82b6";
    }
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = Object.values(FORMATIONS).map(_FormationBuilderAnonymous2);
        $[8] = t5;
    } else {
        t5 = $[8];
    }
...
//# sourceMappingURL=Desktop_Next_js_football_src_0g1zfll._.js.map